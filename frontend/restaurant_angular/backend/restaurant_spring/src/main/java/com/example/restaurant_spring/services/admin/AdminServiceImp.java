...
public class AdminServiceImp implements AdminService {
    ...
    public CategoryDto postCategory(CategoryDto categoryDto) throws IOException {
        ...
        creatCategoryDto.setId(createCategory.getId());
    ...
    public ProductDto postProduct(Long categoryId, ProductDto productDto) throws IOException {
        ...
        if(optionalCategory.isPresent()){
            ...
            createProductDto.setId(createProduct.getId());
    ...
    public List<ReservationDto> getReservations() {
        return reservationRepo.findAll().stream().map(Reseration::getReservationDto).collect(Collectors.toList());
    }

    @Override
    public ReservationDto changeReservationStatus(Long reservationId, String status) {

        Optional<Reseration> optionalReseration = reservationRepo.findById(reservationId);
        if(optionalReseration.isPresent()){
            Reseration existingReseration = optionalReseration.get();
            ...
            Reseration updateReseration = reservationRepo.save(existingReseration);
            ReservationDto updateReservationDto = new ReservationDto();
            updateReservationDto.setId(updateReseration.getId());
